...
public class Idean_20170130{
	public static void main(String[] args) {
		IdeanMan_20170130 idm = new IdeanMan_20170130();
	}
}



class IdeanMan_20170130 implements ActionListener{
	// field
	JFrame frame;
	...
	public void actionPerformed( ActionEvent ae ){
		// 配列関連
			// 配列
			String[] idea1 = {"コーヒー","写真","Red Bull","カレー","パズドラ","マカロン","ドルフィン","はやひで","パチンコ","ヘッドホン","清水寺","水","火","江ノ島","モンスターエナジー","ちくわ","ヘア エクステンション"};
			String[] idea2 = {"コーヒー","写真","Red Bull","カレー","パズドラ","マカロン","ドルフィン","はやひで","パチンコ","ヘッドホン","清水寺","水","火","江ノ島","モンスターエナジー","ちくわ","ヘア エクステンション"};
