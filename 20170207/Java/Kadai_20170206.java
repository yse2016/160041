...
/* 要件
	- Test_20170131.java のver up版
	- ボタンクリックでサイトにアクセスするアプリ
	- 手動でURLを入力してアクセスする
	- 最初の window に終了ボタンを追加
*/
...
class Window implements ActionListener{
	...
	public void actionPerformed( ActionEvent ae ){
		...
		} else if( ac_Cmd.equals("btn_close") ){
			Button_Close bc = new Button_Close();
		}
	}
}
